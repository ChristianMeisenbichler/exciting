...
nullify(np)  
np=>getAttributeNode(thisnode,"SCLPGroups")
getstructgroundstate%SCLPGroups=1
if(associated(np)) then
       call extractDataAttribute(thisnode,"SCLPGroups",getstructgroundstate%SCLPGroups)
       call removeAttribute(thisnode,"SCLPGroups")  
endif
...
getstructSTM%stmtypenumber=stringtonumberSTMstmtype(getstructSTM%stmtype)
...
getstructSTM%stmmodenumber=stringtonumberSTMstmmode(getstructSTM%stmmode)
...
case default
write(*,*) "Parser ERROR: '", string,"' is not valid selection forstmtype "
stop 
end select
end function
...
case default
write(*,*) "Parser ERROR: '", string,"' is not valid selection forstmmode "
stop 
end select
end function
