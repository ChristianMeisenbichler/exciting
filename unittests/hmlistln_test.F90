...
! initialisation is finished
         ...
         nrows_loc = NUMROC(nmatp, MPIkpt_2D%blocksize, MPIkpt_2D%myprocrow, 0, MPIkpt_2D%nprocrows)
         ncols_loc = NUMROC(nmatp, MPIkpt_2D%blocksize, MPIkpt_2D%myproccol, 0, MPIkpt_2D%nproccols)
