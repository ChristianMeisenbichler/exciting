...
! 3rd test 
! The spherically symmetric contibution (line 2 in Eq. 24) to the hamiltonian is under inspection.
! The purpose is to test whether the update of the hamiltonian and the summation over l is done properly.
! The matching coefficients apwalm contain a dependence on the plane-wave index g1, the orbital momentum l1 and the magnetic quantum number m1.
...
! 5th test
! The spherically symmetric and asymmetric contibutions (lines 2 and 4 in Eq. 24) to the hamiltonian are under inspection.
...
! 6th test
! The spherically symmetric and asymmetric contibution (lines 2 and 3 in Eq. 24) to the hamiltonian are under inspection.
